...
def metodoBisseccao(inicio, fim, precisao, f):
...
def main():
	...
	while(True):
		...
		#Executando o metodo da Bisseccao
		resultado = metodoBisseccao(entradas['inicio'], entradas['fim'], entradas['precisao'], f)
		...
		if(resultado != None):
			...
			if(resultTestado < 1):
				...
				arqSaida.write("Resultado maior que 1: ")
				arqSaida.write(resultTestado)
				arqSaida.write('\n')
		else:
